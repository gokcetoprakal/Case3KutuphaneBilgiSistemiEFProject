...
*Bu proje daha sonra devam edilecek n katmanlı bir proje olduğu için diğer projeler de olmaktadır. Asıl ödev CSharpEgitimKampi301.EFProject projesi içinde yapılmıştır.*
## 9 ve 10. Dersler
Bu derslerde MS SQL üzerinden sql kullanımını öğrendim. Tablo oluşturma, veri oluşturma vb.
## 11 ve 12. Dersler
Bu derslerde n katmanlı bir proje mimarisi oluşturmayı, bu projeleri birbirine referans etmeyi ve DAL layerını kullanmayı öğrendim.
## 13. Ders
